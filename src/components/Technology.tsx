        ...
        <section className={`fade-in ${visible ? 'visible' : ''}`}>
            <div>
              <div className="px-3">
                ...
                <p className="text-center font-medium text-xl pt-8">Voici quelques technologies avec lesquelles j'ai travaillé <br/> récemment</p>
              </div>
              <div className="text-center pt-12 px-2">
                <div className="pb-8 flex flex-wrap justify-center lg:justify-center gap-4">
                  <span className="bg-[#38464B] text-white shadow-xl px-4 py-2 rounded-full text-sm font-semibold transition duration-300 ease-in-out hover:-translate-y-1 hover:shadow-2xl hover:bg-slate-600">HTML</span>
                  <span className="bg-[#38464B] text-white shadow-xl px-4 py-2 rounded-full text-sm font-semibold transition duration-300 ease-in-out hover:-translate-y-1 hover:shadow-2xl hover:bg-slate-600">CSS</span>
                ...
                <div className="pb-8 flex flex-wrap justify-center lg:justify-center gap-4">
                  ...
                  <span className="bg-[#38464B] text-white shadow-xl px-4 py-2 rounded-full text-sm font-semibold transition duration-300 ease-in-out hover:-translate-y-1 hover:shadow-2xl hover:bg-slate-600">Bootstrapp</span>
                  <span className="bg-[#38464B] text-white shadow-xl px-4 py-2 rounded-full text-sm font-semibold transition duration-300 ease-in-out hover:-translate-y-1 hover:shadow-2xl hover:bg-slate-600">Adonis JS</span>
                  <span className="bg-[#38464B] text-white shadow-xl px-4 py-2 rounded-full text-sm font-semibold transition duration-300 ease-in-out hover:-translate-y-1 hover:shadow-2xl hover:bg-slate-600">Figma</span>
                </div>
              </div>
            </div>
        </section>
