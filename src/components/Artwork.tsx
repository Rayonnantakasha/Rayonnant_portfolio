    ...
    return (
        <section id='Artwork' className={`fade-in ${visible ? 'visible' : ''}`}>
             <div className='flex justify-center'>
               <h2 className="lg:text-8xl lg:text-center text-5xl px-2 text-center lg:w-[45%] font-black text-outline-white">
             ...
             <div className="flex flex-col bg-[#38464B] shadow-2xs  ">
               <div className="p-4 md:p-10">
                 ...
                 <p className="mt-2 lg:text-left text-gray-100 text-center dark:text-neutral-400">
                 Création d’un site web statique et responsive en HTML et CSS dans le cadre de mes premières semaines de formation à Kadea. Ce projet m’a permis d’apprendre à structurer une page web et à la styliser, en mettant en pratique les bases du développement front-end
                 </p>
                 <a target="_blank" className="mt-8 lg:inline-flex flex justify-center items-center gap-x-1 text-sm font-bold bg-[#ff5940] p-4 hover:bg-orange-800 transition duration-300 ease-in-out " href="https://rayonnantakasha.github.io/agence-sunnyside/">
                   VISITER LE SITE
                 </a>
               </div>
             </div>
